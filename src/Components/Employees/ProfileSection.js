// src/Components/loginpage/loginpage/ProfileSection.js
      ...
      >
        ...
        <div className="profile-section">
          ...
          <div className="profile-grid">
            <div className="field">
              <label><i className="bi bi-hash me-2"></i>Employee ID</label>
        ...
        <div className="profile-section">
          ...
          <div className="profile-grid">
            <div className="field">
              <label><i className="bi bi-house-door me-2"></i>Current Address</label>
              {!isEditing ? (
            ...
            <div className="field">
              <label><i className="bi bi-building me-2"></i>Permanent Address</label>
              {!isEditing ? (
