...
const StatusPill = ({ status }) => {
  ...
  // key forces re-animate when status text changes
      ...
      <section className="panel animate-rise">
        <div className="panel-header">
          ...
          <div className="toolbar">
            <span className="muted">Leaves this month: <strong>{leavesThisMonth}</strong> / 2</span>
          </div>
        </div>
        ...
        <div className="panel-header">
          ...
          <div className="toolbar">
            <div className="filters compact">
              ...
              <button className="ghost-btn tap" onClick={() => { setFilterMonth(''); setFilterStatus(''); }}>
                Reset
              </button>
            </div>
          </div>
        ...
        {isDesktop ? (
          ...
          <div className="leave-cards">
            {filteredLeaves.length === 0 ? (
              ...
              filteredLeaves.map((leave, i) => (
                <div key={leave._id} className="leave-card animate-fade-up" style={{ animationDelay: `${i * 60}ms` }}>
                  ...
                  {(leave.status || '').toLowerCase() === 'pending' && (
                    <div className="card-actions">
                      <button onClick={() => handleCancel(leave._id)} className="danger-btn block tap">
                        Cancel
                      </button>
                    </div>
                  )}
